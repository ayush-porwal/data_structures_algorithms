...
// this will result into N*(N+E) type of solution. Not good for given
// constraints.

// int bfs(vector<vector<int>> &adj, vector<int> &typeOfGoods, int currentNode,
// int s)
// {
//     int ans = 0;
//     queue<int> nodes;
...
// Multi-source BFS: finds shortest distance from ANY source selling a
// particular good type Time: O(n + m) per call
...
int main() {
  ...
  // costMatrix[goodType][city] = distance from city to nearest shop selling
  // goodType We only store k distance arrays, not n*k
